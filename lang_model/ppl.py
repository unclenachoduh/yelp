...
source_files = sorted(os.listdir(sys.argv[5]))
...
for name in source_files:
    ...
    batch_line = "ppl=" + str(finalppl)

    print(batch_line)

    print_line += origin_name + " " + name + "\n" + batch_line + "\n\n"
    # print(batch_line + "\n")
...
batch_out = sys.argv[6]

if batch_out[-1] != "/":
    batch_out += "/"

batch_out += origin_name

print(batch_out)

batch_file = open(batch_out, "w+")
batch_file.write(print_line)
batch_file.close()
